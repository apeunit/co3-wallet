import { GENERATE_MNEMONIC_PHRASE, VALIDATE_MNEMONIC_DATA, CREATE_WALLET, GET_MNEMONIC, SAVE_MNEMONIC } from '../../../redux/actions/Wallet/ActionTypes'
import { generateMnemonicPhrase, validateMnemonicData, createWallet, getMnemonic, saveMnemonic } from '../../../redux/actions/Wallet'
